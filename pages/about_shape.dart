...
class AboutShapePage extends StatelessWidget {
  ...
  @override Widget build(BuildContext context) {
    return Scaffold(
      ...
      FloatingActionButton(child: Icon(Icons.play_circle_filled),
        onPressed: () { demo01Key.currentState.controller.forward();
        },
      ),
    );
  }
...
class _AnimationDemo01State extends State<AnimationDemo01> with SingleTickerProviderStateMixin {
  ...
  Animation<Color> colorAnim; Animation<double> sizeAnim;
  Animation<double> rotationAnim; @override void initState() {
    super.initState();
    ...
    return Center(child: AnimatedBuilder(
      ...
      return Opacity
        ...
        child: Transform(alignment: Alignment.center,
          transform: Matrix4.rotationZ(rotationAnim.value), child: Container(
